    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary" class="card-panel teal lighten-2">
                ...
                <a class="navbar-brand">LabVirtual - ILEEL</a>
                <span class="navbar-brand">
                    Código do vídeo atual:
                    <span id="video_name">
                        <?php echo $video_atual->num_grupo . '.' . $video_atual->num_video; ?>
                    </span>
                </span>
                <div class="collapse navbar-collapse" id="navbarSite">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../contato/index.html" target="_self">Contato</a>
                        </li>
                        <li class="nav-item">
                            <a id="btnSair" class="nav-link" href="../sair/sair.php" target="_self">Sair</a>
                        </li>
            ...
            <div class="container">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-5 align-self-center" style="overflow: hidden;">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="btn-group btn-group-justified d-flex">
                            <button id="play" class="btn btn-primary" type="button" style="font-size:13px;">Checar Gravação/Check Recording</button>
                            <button id="btn_enviar" class="btn btn-primary ml-auto" type="button" style="font-size:13px;">Enviar/Send</button>
                        </div>
